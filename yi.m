function [post,parpos,sayacon]=yi(nofpar,ymax,sayacon,conver)
...
%         [z,~] = TP_KUR_objfun(pos(y,:));
    ...
    [zreelpost,zimajpost,yreelpost,yimajpost]= smithc(post);
      ...
      [sira4] = lbestimaj(yimajfonk,yimajpost);
    
    
    for y=1:nofpar
         
            [pos,conver,sayacon]=sopso_update(pos,parpos,vel,pbest,conver,y,c1,c2,dim,limofpar,sira4,nofpar,sayacon);
