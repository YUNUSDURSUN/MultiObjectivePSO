function [post,parpos,sayacon]=zi(nofpar,ymax,sayacon,conver)
...
%         [z,~] = TP_KUR_objfun(pos(y,:));
 [z,~] = FonsecaAndFleaming(pos(y,:));
    ...
    [zreelpost,zimajpost,yreelpost,yimajpost]= smithc(post);
      ...
      [sira2] = lbestimaj(zimajfonk,zimajpost);
    ...
    for y=1:nofpar
            ...
            [pos,conver,sayacon]=sopso_update(pos,parpos,vel,pbest,conver,y,c1,c2,dim,limofpar,sira2,nofpar,sayacon);
