function [post,parpos,sayacon]=zr(nofpar,ymax,sayacon,conver)
...
%         [z,~] = TP_KUR_objfun(pos(y,:));
 [z,~] = FonsecaAndFleaming(pos(y,:));
    ...
    [zreelpost,zimajpost,yreelpost,yimajpost]= smithc(post);
      ...
      [sira1] = lbestimaj(zreelfonk,zreelpost);

    
    
    for y=1:nofpar
         
            [pos ,conver,sayacon]=sopso_update(pos,parpos,vel, pbest,conver,y,c1,c2,dim,limofpar,sira1,nofpar,sayacon);
